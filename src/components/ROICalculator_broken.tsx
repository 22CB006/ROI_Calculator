          ...
          <div className="bg-white shadow-lg border border-gray-200 flex flex-row" style={{ width: '900px', height: '808px', borderRadius: '12px', padding: '40px' }}>
            ...
            <div className="flex flex-col justify-start w-1/2 pl-8 gap-6">
              ...
              <div className="bg-[#FFECEC] rounded-lg p-6 mb-4">
                <div className="text-[#EF4444] text-[16px] font-normal mb-1">You're losing</div>
              ...
              <button
                ...
                style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}
              >
                <img src="/recalculate.png" alt="Recalculate icon" width={20} height={20} />
                Re-Calculate
              </button>
              {/* Action Buttons */}
      ...
      />
              ...
              <div>
                <div className="flex items-center mb-2">
                  ...
                  <img src="/material-symbols_info-rounded.png" alt="Info icon" width={16} height={16} className="w-4 h-4 ml-2" />
                </div>
                <input
                  type="number"
                  name="costPerError"
