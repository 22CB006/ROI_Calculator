...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center" style={{ width: '1440px', height: '436px', fontFamily: 'Plus Jakarta Sans, sans-serif', backgroundColor: '#04A15B0D', margin: '0 auto', paddingLeft: '64px', paddingRight: '64px' }}>
      <div className="h-full flex flex-col items-center justify-center pt-12 pb-0" style={{ width: '100%' }}>
        ...
        <div className="flex flex-row gap-8 mb-8 justify-center text-[16px] text-gray-700 font-normal">
        ...
        <div className="w-full flex flex-row justify-between items-center py-8" style={{ paddingLeft: '32px', paddingRight: '32px' }}>
          ...
          <div className="text-[16px] text-gray-700 font-normal" style={{ minWidth: '220px' }}>
