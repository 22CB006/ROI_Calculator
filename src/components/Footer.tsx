        ...
        <div className="w-full flex flex-row justify-between items-center py-8" style={{ paddingLeft: '32px', paddingRight: '32px', width: '100%' }}>
          <div className="flex flex-row items-center gap-6">
            <div className="flex flex-row items-center gap-4">
              ...
              <div>
              <div className="text-xs lg:text-[14px] text-[#6F7E8A]" style={{ fontWeight: 500 }}>Have a question?</div>
              <div className="text-sm lg:text-[16px] text-[#131514]" style={{ fontWeight: 500 }}>+01-123-4567</div>
              </div>
            </div>
            <div className="flex flex-row items-center gap-4">
              <div className="bg-[#04A15B] rounded-full flex items-center justify-center" style={{ width: 48, height: 48 }}>
              ...
              <div>
              <div className="text-xs lg:text-[14px] text-[#6F7E8A]" style={{ fontWeight: 500 }}>Contact us at</div>
              <div className="text-sm lg:text-[16px] text-[#131514]" style={{ fontWeight: 500 }}>welcome@unoiatech.com</div>
              </div>
            </div>
          </div>
